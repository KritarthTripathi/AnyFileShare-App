...
import com.kts.sharelock.BuildConfig;
import com.kts.sharelock.fragment.HomeFragment;
    ...
    private void applyAwaitingDrawerAction()
    {
        if (mChosenMenuItemId == 0) {
         ...
         //   finish();
            ...
            wv.loadUrl("https://www.freeprivacypolicy.com/live/50b9f8d7-8327-41fd-9afe-a05e15f9a30c"); //Your Privacy Policy Url Here
