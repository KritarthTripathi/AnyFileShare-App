package com.kts.sharelock.service;
...
import com.kts.sharelock.base.AppConfig;
import com.kts.sharelock.base.Keyword;
import com.kts.sharelock.db.AccessDatabase;
import com.kts.sharelock.fragment.FileListFragment;
import com.kts.sharelock.util.AppUtils;
import com.kts.sharelock.util.CommunicationBridge;
import com.kts.sharelock.util.CommunicationNotificationHelper;
import com.kts.sharelock.util.DynamicNotification;
import com.kts.sharelock.util.FileUtils;
import com.kts.sharelock.util.HotspotUtils;
import com.kts.sharelock.util.NetworkDeviceLoader;
import com.kts.sharelock.util.NetworkUtils;
import com.kts.sharelock.util.NotificationUtils;
import com.kts.sharelock.util.NsdDiscovery;
import com.kts.sharelock.util.TimeUtils;
...
import com.kts.sharelock.model.TextStreamObject;
import com.kts.sharelock.model.TransferGroup;
import com.kts.sharelock.model.TransferInstance;
import com.kts.sharelock.model.TransferObject;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.kts.sharelock.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.kts.sharelock.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.kts.sharelock.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.kts.sharelock.action.IP";
    public static final String ACTION_END_SESSION = "com.kts.sharelock.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.kts.sharelock.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.kts.sharelock.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.kts.sharelock.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.kts.sharelock.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.kts.sharelock.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.kts.sharelock.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.kts.sharelock.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.kts.sharelock.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.kts.sharelock.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.kts.sharelock.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.kts.sharelock.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.kts.sharelock.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.kts.sharelock.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.kts.sharelock.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.kts.sharelock.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.kts.sharelock.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.kts.sharelock.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.kts.sharelock.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.kts.sharelock.transaction.action.REQUEST_WEBSHARE_STATUS";
